...
from utils import compute_extrinsic_matrix, compute_homography, compute_intrinsic_matrix
...
def main():
    ...
    imgpoints, objpoints = load_images(images)
    ...
    img_size = cv2.imread(images[0])[0].shape
    mtx, extrinsics = calibrate_camera(img_size, imgpoints, objpoints)
    # mtx, extrinsics = cv2_example(img_size, imgpoints, objpoints)
